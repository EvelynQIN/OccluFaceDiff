...
class GridVis:
    ...
    def _setup_renderer(self):
        self.render = SRenderY(
            ...
            uv_size=self.model_cfg.model.uv_size).to(self.device)
    ...
    def vis_motion_split(self, motion_split):
        ...
        for model_type in self.model_types:
            ...
            render_image = self.render.render_shape(verts, trans_verts, images=image)
...
def main():
    ...
    # python3 test_lipreading.py --output_folder vis_result/EMOCA/non_occ --model_type diffusion --rec_folder diffusion_sample
    ...
    parser.add_argument('--output_folder', type=str, help='folder to store diffusion exp vis.', required=True)
    ...
    # args.model_types = ['diffusion', 'faceformer', 'facediffuser', 'codetalker'] 
    rec_paths = {
        'diffusion': os.path.join(args.output_folder, 'diffusion_sample'),
        'emoca': 'vis_result/EMOCA/non_occ/EMOCA_reconstruction',
        'deca': 'vis_result/EMOCA/non_occ/EMOCA_reconstruction',
        'spectre': 'vis_result/SPECTRE/non_occ/SPECTRE_reconstruction',
        'faceformer': 'vis_result/FaceFormer/reconstruction',
        'facediffuser': 'vis_result/FaceDiffuser/reconstruction',
        'codetalker': 'vis_result/CodeTalker/reconstruction'
    }
