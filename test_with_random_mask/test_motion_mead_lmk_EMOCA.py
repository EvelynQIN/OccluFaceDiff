...
# python3 test_with_random_mask/test_motion_mead_lmk_EMOCA.py --sld_wind_size 64 --exp_name mouth --save_rec --mask_path vis_RAVDESS/diffusion_Transformer_768d_cat_mediapipelmk_FLINT_testsplit_largeocc/mouth/occ_mask --test_dataset RAVDESS